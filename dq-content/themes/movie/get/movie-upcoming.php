...
$hack_title =__('details','watch') .' '. __('menu','upcoming_movie') . ' '. date( 'Y' ) . $hala .' - ' . $options['weblogo']; 
...
<div class="bd">
            <div class="TpRwCont cont">
                <main>
                    ...
                    <section>
                        <div class="Top">
                            <h1><?php echo __('menu','most_viewed') ;?></h1>
                        </div>
                        <div>
                            <p><?php echo __('utilities','movie_recommendation') ;?> <strong><?php echo __('menu','most_viewed') ;?></strong> <?php echo __('utilities','des_2') ;?> </p>
                        </div>
                        ...
                        <nav class="navigation pagination">
                            ...
                            $link = '/'.$_GET['language'].'/movie-upcoming'; 
                            $pagination = new CSSPagination($totalResults, $limit, $link,'?' );} 
