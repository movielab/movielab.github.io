...
$hack_title =__('details','watch') .' '. __('menu','popular_movie') . ' '. date( 'Y' ) . $hala .' - ' . $options['weblogo']; 
...
<div class="bd">
            <div class="TpRwCont cont">
                <main>
                    ...
                    <section>
                        <div class="Top">
                            <h1><?php echo __('menu','most_rating') ;?></h1>
                        </div>
                        <div>
                            <p><?php echo __('utilities','movie_recommendation') ;?> <strong><?php echo __('menu','most_rating') ;?> <?php echo __('menu','movies') ;?></strong> <?php echo __('utilities','des_2') ;?> </p>
                        </div>
                        ...
                        <nav class="navigation pagination">
                            ...
                            $link = '/'.$_GET['language'].'/movie-popular'; 
                            $pagination = new CSSPagination($totalResults, $limit, $link,'?' );} 
