<?php get_header(); ?>
<meta itemprop="image" content="<?php echo str_replace('https://','https://i0.wp.com/',$singlep['poster_path']);?>"/>
<meta property="og:image" content="<?php echo str_replace('https://','https://i0.wp.com/',$singlep['poster_path']);?>"/>
<meta name="twitter:image" content="<?php echo str_replace('https://','https://i0.wp.com/',$singlep['poster_path']);?>"/>
...
<div class="bd">
            <div class="TpRwCont cont">
                <main>
                    ...
                    <section>
                        <div class="Top">
                            <h1><?php echo $singlep['title'];?> <?php echo __('menu','movies') ;?></h1>
                        </div>
                        <div>
                            <p> <?php echo __('menu','most_viewed') ;?> <strong><?php echo $singlep['title'];?></strong> <?php echo __('utilities','des_2') ;?></p>
                        </div>
                        <ul class="MovieList Rows AX A06 B04 C03 E20">
                                <?php if (is_array($singlep['moviecredit'])) { foreach((array)$singlep['moviecredit'] as $item) {?>
                                <li class="xxx TPostMv">
                                    <div class="TPost C post-<?php echo $item['id'];?> post type-post status-publish format-standard has-post-thumbnail hentry">
                                ...
                                <?php } }?>
		                        <?php if (is_array($singlep['moviecreditcrew'])) { foreach((array)$singlep['moviecreditcrew'] as $item) {?>
		                        <li class="xxx TPostMv">
