...
$hack_title =__('details','watch') .' '. __('menu','popular_tv') . ' '. date( 'Y' ) . $hala .' - ' . $options['weblogo']; 
...
<div class="bd">
            <div class="TpRwCont cont">
                <main>
                    ...
                    <section>
                        <div class="Top">
                            <h1><?php echo __('menu','most_rating') ;?> <?php echo __('menu','tv_shows') ;?></h1>
                        </div>
                        <div>
                            <p><?php echo __('utilities','movie_recommendation') ;?> <strong><?php echo __('menu','most_rating') ;?> <?php echo __('menu','tv_shows') ;?></strong> <?php echo __('utilities','des_2') ;?> </p>
                        </div>
                        ...
                        <nav class="navigation pagination">
                            <?php 
                            if ($serial['total_results'] > 19) : require_once( ABSPATH. '/dq-includes/o_pagination.php'); 
                            if ($serial['total_results'] > 1000) : $totalResults = 1000; else: $totalResults =$serial['total_results']; endif; 
                            $limit= 20; 
                            if ( empty( $_GET['language'] ) ) { 
                            $link = '/tv-popular'; 
                            $pagination = new CSSPagination($totalResults, $limit, $link,'?' ); 
                            }else{ 
                            $link = '/'.$_GET['language'].'/tv-popular'; 
                            $pagination = new CSSPagination($totalResults, $limit, $link,'?' );} 
