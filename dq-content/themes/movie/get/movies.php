<?php 
$hack_title = __('menu','movies') .' '. __('utilities','movie_recommendation') . ' '. date( 'Y' ) .' - ' . $options['weblogo']; 
$titulo = __('menu','movies') .' '. __('utilities','movie_recommendation') . ' '. date( 'Y' ); 
$hack_description = short($hack_title.', Watch All Movies Online, TV online, Putlocker Free Movies Online - '.$single['description']); 
                ...
                <main>
                    ...
                    <section class="home-movies">
                        <div class="Top">
                            ...
                            <p><strong><?php echo __('menu','movies') ;?> </strong> <?php echo __('utilities','des_2') ;?></p>
                        </div>
