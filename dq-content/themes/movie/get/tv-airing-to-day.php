...
$hack_title =__('details','watch') .' '. __('menu','airing_today_tv') . ' '. date( 'Y' ) . $hala .' - ' . $options['weblogo']; 
...
<div class="bd">
            <div class="TpRwCont cont">
                <main>
                    ...
                    <section>
                        <div class="Top">
                            <h1><?php echo __('menu','latest') ;?> <?php echo __('menu','tv_shows') ;?></h1>
                        </div>
                        <div>
                            <p><?php echo __('utilities','movie_recommendation') ;?> <strong><?php echo __('menu','latest') ;?> <?php echo __('menu','tv_shows') ;?></strong> <?php echo __('utilities','des_2') ;?> </p>
                        </div>
                        ...
                        <nav class="navigation pagination">
                            ...
                            $link = '/tv-airing-to-day'; 
                            $pagination = new CSSPagination($totalResults, $limit, $link,'?' ); 
                            }else{ 
                            $link = '/'.$_GET['language'].'/tv-airing-to-day'; 
                            $pagination = new CSSPagination($totalResults, $limit, $link,'?' );} 
