        ...
        <div class="bd" id="top-single" data-id="<?php echo $single['id'];?>">
            <div class="backdrop">
                <article class="TPost movtv-info cont">
                    ...
                    <footer>
                        ...
                        <p class="meta"> <span><?php echo $single['runtime'];?> <?php echo __('details','minutes') ;?></span> <span><?php echo date('Y', strtotime( $single['release_date'] ));?></span> <span class="Qlty">HD</span></p>
                        <ul class="ListPOpt">
                    ...
                    <div class="MvTbCn on anmt" id="MvTb-Info">
                        <ul class="InfoList">
                            <li class="AAIco-adjust"><strong><?php echo __('details','genre') ;?>:</strong> <?php echo $single['genre'];?></li>
                ...
                <ul class="_1EGcQ_0 TPlayerNv tab_language_movie">
                    <li class="open_submenu" data-number>
                        <div class="_3CT5n_0 L6v6v_0">
                            ...
                            <img src="<?php echo get_webinfo('theme_url') ;?>img/subti.svg" alt="Subtitle" class="_15ltj_0">
                    ...
                    <li class="downloadopt">
                        <div class="_3CT5n_0 L6v6v_0 fa-cloud-download-alt aa-mdl">
                            <div class="_1R6bW_0"><a href="/rc?sub_id=<?php echo get_webinfo('sub_id');?>&title=<?php echo $single['title'];?>&movie=<?php echo $single['id'];?>"><span><?php echo __('details','download') ;?> <span><?php echo __('details','hd') ;?></span></span></a></div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="TpRwCont cont">
                    <main>
                        <section>
                            <div class="Top">
                                <h2 class="Title"><?php echo __('details','similar') ;?> <?php echo __('menu','movies') ;?></h2>
                            </div>
